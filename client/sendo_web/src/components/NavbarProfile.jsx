...
import LoginMail from "./ui/UpdateSeller";
    ...
    <div className="bg-white  w-full h-full flex items-center justify-center gap-x-9 pt-2">
      ...
      <div className="">
        <div className="flex">
          ...
          <p
            type="button"
            className="cursor-pointer py-2.5 px-5 me-2  text-sm font-bold text-gray-400 focus:outline-none bg-white rounded-lg  hover:bg-blue-300/30  focus:z-10 "
          >
            Nguyễn Văn A
          </p>
