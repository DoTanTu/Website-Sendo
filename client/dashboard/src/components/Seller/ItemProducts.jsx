...
export default function ItemProducts(props) {
  ...
  return (
    <>
    {
      ...
      <tr key={value.product_id} className="bg-white border-b hover:bg-gray-100 ">
        ...
        <td className="px-6 py-4 flex items-center">
          ...
          <div className='ms-4'  onClick={() => handleDeleteProduct(value.product_id)}>
            <span className='hover:text-red-600 hover:cursor-pointer'><FaRegTrashCan size={20} /></span>
          </div>
        </td>
      </tr>
      ))
